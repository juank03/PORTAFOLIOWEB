...
function Acerca() {
  return (
    <div className="acerca">
      ...
      <a className="me" href="https://drive.google.com/file/d/1IQgbs0iJNeSrOA1Dqpu46Jo3TkDgZtq2/view?usp=drive_link" target="_blank" download>Descargar currículum</a>
      <br /><br />
      <p>
      ...
      <a className="me" href="https://drive.google.com/file/d/1208CHpom2GowPHMa24sHZ_3STak5OWVU/view?usp=drive_link" target="_blank" download>Descargar plantilla de Kodigo</a>
    </div>
